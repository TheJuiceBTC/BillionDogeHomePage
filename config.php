...
define('BASE_HTTP_PATH', 'http://thebilliondogehomepage.blockchainauctions.com/'); 
define('SERVER_PATH_TO_ADMIN', '/home/realp5/public_html/TheBillionDogeHomePage/admin/');
define('UPLOAD_PATH', '/home/realp5/public_html/TheBillionDogeHomePage/upload_files/');
define('UPLOAD_HTTP_PATH', 'http://thebilliondogehomepage.blockchainauctions.com/upload_files/');
define('MYSQL_HOST', 'localhost'); # mysql database host
define('MYSQL_USER', 'realp5_TBD'); #mysql user name
define('MYSQL_PASS', 'nopass'); # mysql password
define('MYSQL_DB', 'realp5_TBD'); # mysql database name
...
define('SITE_LOGO_URL', stripslashes('http://thebilliondogehomepage.blockchainauctions.com/pix/dogecoinsmall.jpg'));

# SITE_NAME
# change to your website name
define('SITE_NAME', stripslashes('The Billion Doge Homepage')); 

# SITE_SLOGAN
# change to your website slogan
define('SITE_SLOGAN', stripslashes('Wooof Wooof whoooozoers 1 pixel = 1 doge')); 
